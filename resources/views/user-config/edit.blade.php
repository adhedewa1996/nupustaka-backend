...
@section('content')
    ...
    <div class="card">
      <div class="card-body">
        <form action="{{ url('/admin/user-config-update/'.$user->id) }}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="row">
            <div class="col-md-4">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="" action="{{ url('/admin/user-config-topup/'.$user->id) }}" method="post">
        {{ csrf_field() }}
