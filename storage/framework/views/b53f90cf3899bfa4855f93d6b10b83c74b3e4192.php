...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
      <div class="card-body">
        <form action="<?php echo e(url('/admin/books-store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <?php if($errors->has('category_id')): ?>
                    <div class="error text-danger"><?php echo e($errors->first('category_id')); ?></div>
                <?php endif; ?>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\HAMURA\NU-PUSTAKA_\Back-End\app.nupustaka.com\resources\views/books/create.blade.php ENDPATH**/ ?>